        ...
        <div className="classroom min-vh-100 bg-image" style={{backgroundImage:`url(${classroom})`}}>
            ...
            <div className="activity1-explanation">
                ...
                <div className="grid-container">
                    <a className="btn grid-item wrong" id="1"><p>Wait until everyone is in class</p></a>
                    <a className="btn grid-item right" id="2"><p>Play a short game that the kids know</p></a>
                    <a className="btn grid-item wrong" id="3"><p>Start distributing papers for the class</p></a>
                    <a className="btn grid-item right" id="4"><p>Ask the kids how they are doing</p></a>
                    <a className="btn grid-item wrong" id="5"><p>Ask about homework</p></a>
                    <a className="btn grid-item wrong" id="6"><p>Go directly to the topic of the day</p></a>
                    <a className="btn grid-item wrong" id="7"><p>“Hello, everyone! We have a test today!”</p></a>
                    <a className="btn grid-item wrong" id="8"><p>“Hi, Laura! You look very nice today!”</p></a>
                    <a className="btn grid-item right" id="9"><p>“Hello, Laura! How is your day going?”</p></a>
                </div>
